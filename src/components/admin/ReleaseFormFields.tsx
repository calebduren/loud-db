        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <select
                {...field}
                className="flex h-[--input-height] w-full rounded-md border border-white/10 bg-white/5 px-3 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-white/20 focus:border-white/20"
              >
